...
public class Main
{
    public static void main(String[] args)
    {
        ...
        Agent iAmThePlayer = new MyAgent(game, true); // create the red player, any subclass of Agent
        Agent yellowPlayer = new RandomAgent(game, false); // create the yellow player, any subclass of Agent
        
        Connect4Frame mainframe = new Connect4Frame(game, iAmThePlayer, yellowPlayer); // create the game window
    }
}
